...
var dialogue_lines = [
	{"text": "You eye the Dreemurr Book shelf..its full of books about botany and baking", "image": ""},
	{"text": "Mmmmh what kind of books are these...", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_curious.png"},
	{"text": "Fhahah there is a manga here", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_smile-happy.png"},
	{"text": "Strange how there is a book like this here ...", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_happy.png"},
	{"text": "Kris probably left it here.", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_happy.png"}
]
...
func _on_body_entered(body):
	if body.name == "Player":
		...
		print("Player near bookshelf")

func _on_body_exited(body):
	if body.name == "Player":
		player_in_range = false
		print("Player left bookshelf")
