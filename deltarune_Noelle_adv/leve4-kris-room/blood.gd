...
var dialogue_lines = [
	...
	{"text": "although... its bugging me..", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_relaxing.png"},
	{"text": "I really want to clean it ... ", "image": "res://talking_head/noellee/noelle_heads_clean_nopink_sigel_thinking.png"}
]
...
func _on_body_entered(body):
	if body.name == "Player":
		...
		print("Player near object")

func _on_body_exited(body):
	if body.name == "Player":
		player_in_range = false
		print("Player left object")
